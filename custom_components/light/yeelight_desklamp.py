...
DEFAULT_NAME = 'Xiaomi Yeelight Desk Lamp'
PLATFORM = 'yeelight_desklamp'
...
def async_setup_platform(hass, config, async_add_devices, discovery_info=None):
    ...
    try:
        ...
        desklamp = YeelightDeskLamp(name, light, device_info)
...
class YeelightDeskLamp(Light):
    ...
    def async_turn_on(self, **kwargs):
        ...
        if ATTR_COLOR_TEMP in kwargs:
            ...
            result = yield from self._try_command(
                ...
                self._light.set_color_temp, percent_color_temp)
    ...
    def async_update(self):
        ...
        try:
            ...
            self._color_temp = self.translate(state.color_temp, CCT_MIN, CCT_MAX, self.max_mireds, self.min_mireds)
